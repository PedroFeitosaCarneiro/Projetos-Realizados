...
//  MacroChallenge
//
//  Created by Rangel Cardoso Dias on 22/10/20.
    ...
    private func skeletonViews(in view: UIView) -> [UIView] {
        ...
        for subview in view.subviews as [UIView] {
            ...
            case _ where subview.isKind(of: UIButton.self):
                results += [subview]
//            case _ where subview.isKind(of: UICollectionView.self):
//                results += [subview]
//            case _ where subview.isKind(of: UICollectionViewCell.self):
//                results += [subview]
