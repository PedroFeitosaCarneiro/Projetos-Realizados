...
class OnboardingPageViewController: UIPageViewController {
    ...
    private func newOnboardingViewController(page: Pages) -> UIViewController {
        switch page {
            case .One:
                return PageOneOnboardingViewController()
            case .Two:
                return PageTwoOnboardingViewController()
            case .Three:
                return PageThreeOnboardingViewController()
        }
    }
    ...
    private func configurePageControl() {
        ...
        pageControl.pageIndicatorTintColor = UIColor(rgb: 0xA8A8A8)
        pageControl.currentPageIndicatorTintColor = UIColor(rgb: 0x52C4C0)
